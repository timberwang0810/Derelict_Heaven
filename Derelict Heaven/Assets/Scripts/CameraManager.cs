...
public class CameraManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            cam.transform.position = Vector3.Lerp(cam.transform.position, moveTo, Time.deltaTime * 2);
        }
    }

    public void SolvePuzzlePan(GameObject door)
    {
        StartCoroutine(PanCamera(door));
    }

    private IEnumerator PanCamera(GameObject door)
    {
